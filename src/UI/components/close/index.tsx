...
import { hoverFocus } from '../../mixins/utils/hover'
...
class CloseUnstyled extends React.Component {
  ...
  render() {
    // @ts-ignore
    const { className, 'sr-only': srOnly, onDismiss, closeLabel, cssModule, ...attributes } = omit(
      this.props,
      ['theme'],
    )
    return (
